...
/**
 * Created by weisi on 2017/7/3.
 */

public class ShowProgressJ extends FrameLayout {
    /**
     * 存放三个小球的集合
     */
    ...
    public ShowProgressJ(Context context) {
        super(context);
        init();
    }

    public ShowProgressJ(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ShowProgressJ(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.show_progress_j, this, true);
        assignViews();
        startAnimator();
    }
    ...
    private ObjectAnimator startAnimator1() {
        /**对象的不同属性组合**/
        PropertyValuesHolder objectAnimatorTranslation = PropertyValuesHolder.ofFloat("translationX", -100, -150, -100, 0, 100, 150, 100, 0, -100);
        ...
        objectAnimator.setRepeatCount(-1);//此处不限
    ...
    private ObjectAnimator startAnimator2() {
        /**对象的不同属性组合**/
        PropertyValuesHolder objectAnimatorTranslation = PropertyValuesHolder.ofFloat("translationX", 0, 100, 150, 100, 0, -100, -150, -100, 0);
        ...
        objectAnimator.setRepeatCount(-1);//次数不限
        objectAnimator.setInterpolator(new LinearInterpolator());
        objectAnimator.setDuration(2000);
        objectAnimator.start();
        return objectAnimator;
    ...
    private ObjectAnimator startAnimator3() {
        /**对象的不同属性组合**/
        PropertyValuesHolder objectAnimatorTranslation = PropertyValuesHolder.ofFloat("translationX", 100, 0, -100, -150, -100, 0, 100, 150, 100);
